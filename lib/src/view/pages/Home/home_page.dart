            ...
            children: [
              ...
              Container(
                ...
                child: const ListTile(
                    leading: Text('There are no more results',
                        style: TextStyle(fontSize: 16, color: Colors.white)),
                    trailing: Text('Thank you for watching',
          ...
          child: Column(
            children: [
              Container(
                color: Colors.blue,
                child: ListTile(
                    leading: Text('Option button'), trailing: Text('No. 1')),
              ),
              Container(
                color: Colors.white,
                child: ListTile(
                    leading: Text('Option button'), trailing: Text('No. 2')),
              ),
            ],
          ),
        ),
          ...
          children: [
            Container(
              ...
              child: ListTile(
                  ...
                  trailing: Text('UNetflix Original',
                      style: TextStyle(fontSize: 18, color: Colors.white))),
            ),
            Container(
              color: Colors.black,
